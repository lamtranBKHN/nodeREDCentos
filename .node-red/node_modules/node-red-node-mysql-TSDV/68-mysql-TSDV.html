...
<script type="text/html" data-template-name="MySQLdatabaseTSDV">
    <div class="form-row">
...
<script type="text/javascript">
    RED.nodes.registerType('MySQLdatabaseTSDV',{
        category: 'config',
        defaults: {
            name: {value:""},
...
<script type="text/html" data-template-name="mysqlTSDV">
    <div class="form-row">
...
<script type="text/html" data-help-name="mysqlTSDV">
...
<script type="text/javascript">
    RED.nodes.registerType('mysqlTSDV',{
        category: 'TSDV',
        color:"lightblue",
        defaults: {
            mydb: {type:"MySQLdatabaseTSDV"},
            name: {value:""}
        },
        inputs:1,
        outputs:1,
        ...
        label: function() {
            ...
            return this.name||(levelNode?levelNode.label():"mysql-TSDV");
        },
        labelStyle: function() {
