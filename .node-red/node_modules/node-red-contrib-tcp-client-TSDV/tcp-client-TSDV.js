...
module.exports = function(RED) {
        ...
        if (!node.server) {
            ...
            var setupTcpClient = function() {
                ...
                client = net.connect(node.port, node.host, function() {
                    ...
                    node.status({fill:"green",shape:"dot",text:localPort,_session:{type:"tcp",id:id}});
                });
            ...
            var server = net.createServer(function (socket) {
				...
				localPort = connectionPool[id].remotePort;
    ...
    RED.nodes.registerType("tcp in TSDV",TcpIn);
    ...
    RED.nodes.registerType("tcp out TSDV",TcpOut);
    ...
    function TcpGet(n) {
        ...
        this.on("input", function(msg, nodeSend, nodeDone) {		
         ...
         var host = node.server || process.env.DAS_Server_ip;
         var port = node.port || process.env.DAS1_port;
           
	if(msg.host !== host) host = msg.host;
	if(msg.port !== port) port = msg.port;
	 // Store client information independently
            ...
            if (!clients[connection_id].connecting && !clients[connection_id].connected) {
                ...
                if (host && port) {
                    ...
                    clients[connection_id].client.connect({host, port}, function() {
                        //node.log(RED._("tcpin.errors.client-connected"));
                        node.status({fill:"green",shape:"dot",text:"connected at localPort " +msg.localPort});
                ...
                clients[connection_id].client.on('error', function() {
                    //console.log("ERROR");
                    node.status({fill:"red",shape:"ring",text:"error disconnected"});
    ...
    RED.nodes.registerType("tcp request TSDV",TcpGet);
}
